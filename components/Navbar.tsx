...
const Navbar: React.FC<NavbarProps> = ({ cartCount, onCartClick, onNavigate }) => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 w-full z-40 transition-all duration-700 border-b ${scrolled
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          >
            <h1 className="font-serif text-2xl md:text-3xl tracking-widest text-gold-light group-hover:text-gold-champagne transition-all duration-500 text-glow">
              LUMIÈRE
            </h1>
          ...
          <div className="flex items-center space-x-6">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 w-5 h-5 bg-gradient-gold text-black text-[10px] font-bold flex items-center justify-center rounded-full animate-pulse-gold shadow-gold">
                  {cartCount}
                </span>
              )}
            </button>
